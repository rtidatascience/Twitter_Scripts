...
(5) Rob Chew - updated to work on Python 3.4+ (2014-12)
...
EdgePunctLeft  = re.compile(offEdge + "("+edgePunct+"+)("+notEdgePunct+")")
EdgePunctRight = re.compile("("+notEdgePunct+")("+edgePunct+"+)" + offEdge)
